  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-8">
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            {claim.ocrError && (
              <p
                className={cn(
                  "max-w-sm rounded px-3 py-1.5 text-xs",
                  issueBannerClass,
                )}
              >
                {claim.ocrError}
            ...
            <CardContent className="flex items-start gap-3 py-4 text-sm">
              ...
              <div>
                ...
                <p className="mt-1 text-muted-foreground">
                  This claim was submitted by a member account. Admin claim
          ...
          <Card className="border">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs text-muted-foreground pt-1">
                <span>
                  Confidence: {Math.round((extAudit.confidence ?? 0) * 100)}%
                </span>
              ...
              {orgRole === "org:admin" && (
                <div className="mt-3">
                  <p className="text-xs text-muted-foreground mb-1">
                    Raw Audit JSON (admin only)
                  </p>
                  <pre className="whitespace-pre-wrap rounded bg-muted p-2 text-xs overflow-auto max-h-64">
                    {JSON.stringify(extAudit, null, 2)}
                  </pre>
                </div>
              )}
            </CardContent>
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                      ...
                      <span className="text-xs">
                        Receipt date differs from your claimed date by more than
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{submissionLabel}</CardTitle>
          </CardHeader>
          <CardContent>
            <dl className="space-y-3 text-sm">
              {isAdminView && (
